document.addEventListener('DOMContentLoaded', () => {
  ...
  function openSignInModal() {
    ...
    if (passwordInput && passwordIcon) {
      ...
      passwordIcon.src = '../../Internship-Assessment-System/static/images/components/login_password.png';
    }
  }
  ...
  function attachModalListeners(modalContent) {
        ...
        if (result.status === 'success') {
          ...
          switch (userRole) {
            case 'executive director':
              redirectPath = '/Internship-Assessment-System/templates/schooluser/admin/home.html';
              break;
            ...
            case 'internship officer':
              ...
              break;
            case 'student intern':
              redirectPath = '/Internship-Assessment-System/templates/schooluser/student/home.html';
              break;
            case 'supervisor':
              redirectPath = '/Internship-Assessment-System/templates/supervisor/_index.html';
              break;
            default:
    ...
    modalContent.querySelector('.toggle-password').addEventListener('click', (e) => {
      ...
      if (type === 'text') {
        e.target.src = '/Internship-Assessment-System/static/images/components/login_password_show.png'; // Eye open
      } else {
        e.target.src = '/Internship-Assessment-System/static/images/components/login_password.png'; // Eye closed
      }
    });
      ...
      <form id="otp-form">
        <div class="input-group">
          ...
          <div class="input-wrapper">
            ...
            <img src="/Internship-Assessment-System/static/images/components/email_logo.png" alt="Email Icon" class="input-icon" />
          </div>
